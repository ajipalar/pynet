...
from ._typedefs import PRNGKeyArray, Index
import io
import jax
...
def not_ones_trivial(n_samples, n_inter, ais: PynetModule, dist):
...
def specialize_model_to_sampling_trivial(
    n_samples: int, n_inter: int, decimals, ais: PynetModule, dist: PynetModule
):
...
def sample_trivial(
    ...
    packed = testdef_get_trivial_model(n_samples=n_samples, n_inter=n_inter, dist=None)
