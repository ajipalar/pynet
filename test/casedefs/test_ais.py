...
from test.testdefs import ais_testdefs as td
...
class DevPropertyTrivial(IMP.test.TestCase):
    ...
    td.trivial_is_get_invariants_jittable(1, 2)
    ...
    def test_trivial(self, n1, n2):
        td.trivial_is_get_invariants_jittable(n1, n2)
...
class DevTrivialAIS(IMP.test.TestCase):
    ...
    def test_model_getter1(self):
        td.trivial_is_get_invariants_jittable(self.n1, self.n1)
    ...
    def test_model_getter8(self):
        td.trivial_is_get_invariants_jittable(self.n8, self.n8)
    ...
    def test_model_getter64(self):
        td.trivial_is_get_invariants_jittable(self.n64, self.n64)
    ...
    def test_model_getter512(self):
        td.trivial_is_get_invariants_jittable(self.n512, self.n512)
    ...
    def test_model_getter4k(self):
        td.trivial_is_get_invariants_jittable(self.n4k, self.n4k)
    ...
    def test_model_getter32k(self):
        td.trivial_is_get_invariants_jittable(self.n32k, self.n32k)
