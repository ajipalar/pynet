...
def gibbsf(key: PRNGKeyArray, 
    ...
    def inner_body_fun(i: int, 
                       init_val
                       ) -> tuple[PRNGKeyArray, float, float]:
...
def generic_gibbsf(key : PRNGKeyArray,
                   nsamples : int,
                   thin_every : int,
                   nparams : Dimension,
    ...
    def outer_body_fun(i: int, val) -> tuple[PRNGKeyArray, PRNGKeyArray, int, DeviceArray, DeviceArray]:
...
def generic_gibbs(key : PRNGKeyArray,
                   nsamples : int,
                   thin_every : int,
                   nparams : Dimension,
                   init_params : Callable,
